...
public class ManageAssetHandler extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        else if(source.equals("assetreport"))
        {
            String filepath = "C:/Users/Afiq/OneDrive/Documents/NetBeansProjects/ITAM/web/assets/reports/report.csv";
            ...
            try (CSVWriter writer = new CSVWriter(new FileWriter(filepath))) {
                ...
                // Write data
                /*for (Assets asset : asset) {
                String[] data = personToCsvData(person);
        ...
        else if(source.equals("assetreport1"))
        {
            
            
           /* String FILE_NAME="C:/Users/Afiq/OneDrive/Documents/NetBeansProjects/ITAM/web/assets/reports/output.xlsx";
